...
class MyNN(nn.Module):
    def __init__(self):  # The constructor of MyNN. Here you specify which and how many layers the Network has.
        super().__init__()
    ...
    def forward(self, x):
        '''
        Here you specify in which order the layers are called.
        :param x: The batch you get when you call model(batch)
        :return: Outputs of your model
        '''
        x = torch.flatten(x, 1)
...
class MyCNN(nn.Module):
    def __init__(self):
        ...
        self.input_layer = BasicConv2d(1, 8, kernel_size=3)  # A "layer" can also be a self implemented module
